        ...
        render={() => {
          return (
            <>
              ...
              <div class="fullpage">
                <div className="section bg-orange h-[100vh] flex flex-col items-center text-center">
                  <div class="">
                    <div class="flex flex-col items-center">
                      ...
                      <div class="flex flex-col md:flex-row justify-center">
                        ...
                        <button class="button text-white bg-darker-blue mx-20 md:mx-3 my-2 md:my-8 hover:bg-transparent hover:text-darker-blue hover:border-darker-blue hover:border-2">
                          <a
                            href="https://github.com/alvarotrigo/fullpage.js/archive/master.zip"
                            target="_blank"
                          >
                            Download
                          </a>
                  ...
                  <div class="items-center">
                    <div class="slide flex items-center" data-anchor="slide1">
                      <div class="flex flex-col">
                        ...
                        <h3 class="text-center text-3xl md:text-5xl md:my-2 text-white pt-6 mx-12">
                          fullPage.js is actively maintained and community
                          driven.
                        </h3>
                    ...
                    <div class="slide flex items-center" data-anchor="slide2">
                      <div class="flex flex-col items-center">
                        ...
                        <h3 class="text-center text-3xl md:text-5xl md:my-2 text-white pt-6 mx-12">
                          Proud of being the most complete framework of its
                          kind.
                        </h3>
                        <h3 class="text-center text-3xl md:text-5xl  text-white mx-12">
                        ...
                        <img
                          class="mt-[5rem] m-auto"
                          src="https://alvarotrigo.com/fullPage/imgs/trusted-by-big.png"
                        />
                      </div>
                    </div>
                    <div class="slide flex items-center" data-anchor="slide3">
                      <div class="flex flex-col items-center">
                        ...
                        <img
                          class="mt-[5rem] m-auto"
                          src="https://alvarotrigo.com/fullPage/imgs/compatible.png"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="items-center">
                    <div class="flex flex-col items-center justify-center">
                      ...
                      <h3 class="text-3xl md:text-5xl md:my-2 text-white text-center pt-6 mx-12">
                        ...
                        It includes tens of examples, great documentation and
                        both community and personal support.
                      </h3>
                    </div>
                  </div>
                </div>
